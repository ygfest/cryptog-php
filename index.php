...
<body>
  ...
  <h2 class="card-header" style="font-weight: 800; background-color: white;">CRYPTOGRAPHY</h2>
...
#example1 {
  ...
  border-block-color: green;
	 ...
	 <div class="card-body">
		...
		<h4 class="card-title">What is Cryptography?</h4>
		<div id="example1"></div>
        <p class="card-text">
          Cryptography involves concealing or encoding information to ensure that only the intended recipient of a message can comprehend it. This ancient practice has been employed for millennia and persists in applications such as bank cards, computer passwords, and e-commerce. 
...
<h4 class="card-title">Brief History of Cryptography</h4>
		<div id="example1"></div>
        <p class="card-text">
          The history of cryptography spans thousands of years, dating back to ancient civilizations. Early cryptographic techniques were primarily used for secret communication and included methods like simple substitution ciphers. 
...
<h4 class="card-title">Importance of Cryptography</h4>
		<div id="example1"></div>
        <p class="card-text">
          
Cryptography holds paramount importance in the modern world for several reasons:
...
<h6>In essence, cryptography is a cornerstone of cybersecurity, providing the tools and techniques necessary to secure digital assets, maintain privacy, and enable trust in the increasingly interconnected and digitalized world.
